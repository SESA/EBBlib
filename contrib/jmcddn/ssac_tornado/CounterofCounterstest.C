...
int
dosomething(integerCounter *counter, int action)
{ 
...
void
worker(integerCounter *counter, request *requests, int numids)
{
...
void
startworker(integerCounter *counter, request *requests, int numids)
{
    //setup
...
driver()
{
    integerCounter *counter = new CounterLocalized;
